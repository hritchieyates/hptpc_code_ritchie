...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
   ...
   */
   ...
   if(Scheme == "SchemeA"){
     PeakCorrections.push_back(54.06);
     PeakCorrections.push_back(44.72);
     PeakCorrections.push_back(42.27);
     PeakCorrections.push_back(37.83);
     PeakCorrections.push_back(28.79);
   }
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Corrected_3Day_"+SchemeName+"_Anode3PeakmV_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Gas Gain");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Corrected_3Day_"+SchemeName+"_peakGain_"+"Custom"+".pdf").c_str());
   }
