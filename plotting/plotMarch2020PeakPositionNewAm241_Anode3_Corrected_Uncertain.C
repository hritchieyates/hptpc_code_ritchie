  ...
  */
   ...
   */
   ...
   std::vector<double> PeakCorrections;
     ...
     PeakCorrections.push_back(59.94);
     PeakCorrections.push_back(50.60);
     PeakCorrections.push_back(48.15);
     PeakCorrections.push_back(43.71);
     PeakCorrections.push_back(34.67);
   ...
   for(int chisub1 = 0; chisub1 < Chis4.size(); chisub1++){
    ...
    for(int errorsub2a = 0; errorsub2a < peakErrors2.size(); errorsub2a++){
	 ...
	 ageingUncertaintyVector.push_back(80);
       }
     }
   }
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/CORRECTEDUNCERTAINPEAKPOSITIONTEST_"+SchemeName+"_Anode3_"+".pdf").c_str());
   }
