...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
  ...
  if(Scheme == "GasAgeing"){
    ...
    runDateTime.push_back(20.690);
    runDateTime.push_back(19.894);
  }
   ...
   */
   ...
   for(int iZack = 0; iZack < 5; iZack++){
     ...
     zackFileName << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/fitDataTEST" << SchemeName << "_" << GainString << voltageForName.str() << ".dat";
   ...
   */
   ...
   Double_t Interp_3day_A1 = peakGraph2->Eval(21.353, 0, "");
   Double_t Interp_3day_A2 = peakGraph2->Eval(21.513, 0, "");
   Double_t Interp_3day_A3 = peakGraph2->Eval(21.555, 0, "");
   Double_t Interp_3day_A4 = peakGraph2->Eval(21.631, 0, "");
   Double_t Interp_3day_A5 = peakGraph2->Eval(21.786, 0, "");
   Double_t Interp_3day_C1 = peakGraph2->Eval(23.339, 0, "");

   std::cout << "Interp_3day_A1 = " << Interp_3day_A1 << std::endl;
   std::cout << "Interp_3day_A2 = " << Interp_3day_A2 << std::endl;
   std::cout << "Interp_3day_A3 = " << Interp_3day_A3 << std::endl;
   std::cout << "Interp_3day_A4 = " << Interp_3day_A4 << std::endl;
   std::cout << "Interp_3day_A5 = " << Interp_3day_A5 << std::endl;
   std::cout << "Interp_3day_C1 = " << Interp_3day_C1 << std::endl;

   std::cout << "Correction_to_A1 = " << Interp_3day_C1 - Interp_3day_A1 << std::endl;
   std::cout << "Correction_to_A2 = " << Interp_3day_C1 - Interp_3day_A2 << std::endl;
   std::cout << "Correction_to_A3 = " << Interp_3day_C1 - Interp_3day_A3 << std::endl;
   std::cout << "Correction_to_A4 = " << Interp_3day_C1 - Interp_3day_A4 << std::endl;
   std::cout << "Correction_to_A5 = " << Interp_3day_C1 - Interp_3day_A5 << std::endl;
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Fitted"+SchemeName+"_Anode3PeakmV_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Gas Gain");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Fitted"+SchemeName+"_peakGain_"+"Custom"+".pdf").c_str());
   }
