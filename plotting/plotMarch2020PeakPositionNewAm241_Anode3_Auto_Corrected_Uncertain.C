...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = true){
   ...
   // listFilePrefix = "peakschi";
    //GasAgeing
    //SchemeA
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2081070-R2081084_true_Am241.root.dat");
    ...
    //SchemeB
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2082009-R2082024_true_Am241.root.dat");
    ...
    //SchemeC
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2083022-R2083032_true_Am241.root.dat");
   ...
   //Fit Gas ageing plot and work out corrections from it
    ...
    c1->Print("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/AUTO_CORRECTED_UNCERTAIN_BKGR12_TEST_GASAGEING_Anode3.pdf");
   ...
   */
   ...
   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Anode 3 Peak Position");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/AUTO_CORRECTED_UNCERTAIN_PEAKPOSITION_TEST_"+SchemeName+"_Anode3"+".pdf").c_str());
   }
