...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = true){
  ...
  */
  ...
  if(Scheme == "SchemeYZ" || Scheme == "AllSchemesMod2"){
  ...
  if(Scheme == "SchemeA" || Scheme == "AllSchemesMod2"){  
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
    runNumbers.push_back(2081073);
  ...
  if(Scheme == "SchemeCMod2" || Scheme == "AllSchemesMod2"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
  ...
  if(Scheme == "SchemeBMod2" || Scheme == "AllSchemesMod2"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
   ...
   */
   ...
   //Turn peaks into gain
    ...
    if(Scheme == "SchemeCMod2"){
      //xplot = schemeCCustomVoltage;
      xplot = a2a1Voltage;
      TGraphErrors* peakGraph2 = new TGraphErrors(6,&(xplot[0]),&(yplot[0]),0,&(yploterrors[0]));
    ...
    if(Scheme == "AllSchemesMod2"){
      xplot = runDateTime;
      TGraphErrors* peakGraph2 = new TGraphErrors(25,&(xplot[0]),&(yplot[0]),0,&(yploterrors[0]));
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/BackgroundsThurFriTEST_"+SchemeName+"_Anode3Bkgr2_"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Bkgr11");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/BackgroundsThurFriTEST_"+SchemeName+"_Anode3Bkgr1_"+".pdf").c_str());
   }
