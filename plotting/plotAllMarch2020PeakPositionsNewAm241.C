...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Backgrounds"+SchemeName+"_Anode3PeakPositions_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Bkgr11");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Background"+SchemeName+"_Anode3Bkgr1_"+"Custom"+".pdf").c_str());
   }
