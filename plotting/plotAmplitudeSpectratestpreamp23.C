...
void plotAmplitudeSpectratestpreamp23(std::string inputFileName = "test.root", bool cuts = true, int rebin = 2, double min = -50, double max = 250, std::string outFileExtension = ".png", bool changeRange = true){
  ...
  TF1 *fitFcn = new TF1("fitFcn",fitFunction,50,150,5);
  fitFcn->SetParameters(4,-0.01,200,200,10);

  TF1 *fitFcn3 = new TF1("fitFcn3",fitFunction,150,200,5);
  fitFcn3->SetParameters(4,-0.01,30,350,10);

  TF1 *fitFcn4 = new TF1("fitFcn4",fitFunction,190,250,5);
  fitFcn4->SetParameters(4,-0.01,30,450,10);

  TF1 *Sgnl4 = new TF1("Sgnl4",Signal,400,500,3);
  Sgnl4->SetParameters(30,400,10);

  TF1 *fitFcn7 = new TF1("fitFcn7",fitFunction,250,350,5);
  fitFcn7->SetParameters(4,-0.01,10,600,5);

  TF1 *Bkgr = new TF1("Bkgr",Background,50,350,2);
  ...
  TF1 *fitFcn2 = new TF1("fitFcn2",fitFunction2,50,350,11);
  ...
  TF1 *fitFcn8 = new TF1("fitFcn8",fitFunction8,50,350,14);
  Double_t pars8[14] = {4,-0.01,200,200,10,30,350,10,30,450,10,10,600,5};
  //fitFcn8->SetParameters(pars8);

  TF1 *fitFcn9 = new TF1("fitFcn9",fitFunction5,50,350,8);
  //fitFcn9->SetParameters(4,-0.01,200,200,10,30,350,10);
  ...
  for(int i = 1; i <= 1; i++){
	...
	HPeakMinusBaselineAnode3->GetXaxis()->SetRangeUser(min, max); 
      ...
      //Initial fit
      HPeakMinusBaselineAnode3->Fit(Sgnl, "R");
      ...
      fitFcn->SetParameters(bkgr01,bkgr02,000,100,10);
      fitFcn3->SetParameters(bkgr01,bkgr02,30,160,10);
      fitFcn4->SetParameters(bkgr01,bkgr02,30,210,10);
      fitFcn7->SetParameters(bkgr01,bkgr02,20,260,5);
