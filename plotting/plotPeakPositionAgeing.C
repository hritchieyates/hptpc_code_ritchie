...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
  ...
  if(Scheme == "GasAgeing"){
    //GasAgeing
    //Number 1
    resultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/peakschi_raptorr_tpcdata_gain_R2081070-R2081074_true_Am241.root.dat");
    paramsFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/parameters_raptorr_tpcdata_gain_R2081070-R2081074_true_Am241.root.dat");
    //Number 2
    resultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/peakschi_raptorr_tpcdata_gain_R2081080-R2081084_true_Am241.root.dat");
    paramsFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/parameters_raptorr_tpcdata_gain_R2081080-R2081084_true_Am241.root.dat");
    //Number 3                                                                                                                                                                                                          
    resultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/peakschi_raptorr_tpcdata_gain_R2081075-R2081079_true_Am241.root.dat");
    paramsFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/parameters_raptorr_tpcdata_gain_R2081075-R2081079_true_Am241.root.dat");
    
    //runNumbers.push_back(2080149);
    runNumbers.push_back(2081072);
    runNumbers.push_back(2081082);
    runNumbers.push_back(2081077);
    //runNumbers.push_back(2079060);
    runDateTime.push_back(21.348);
    runDateTime.push_back(21.402);
    runDateTime.push_back(21.375);
  }
   ...
   */
   ...
   for(int iZack = 0; iZack < 5; iZack++){
     ...
     zackFileName << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/fitDataAgeing" << SchemeName << "_" << GainString << voltageForName.str() << ".dat";
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Ageing"+SchemeName+"_Anode3PeakmV_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Gas Gain");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Ageing"+SchemeName+"_peakGain_"+"Custom"+".pdf").c_str());
   }
