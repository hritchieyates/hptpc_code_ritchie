...
void plotPeakPositionNewAm241(std::string plottoplot= "noplot", bool gain = false){
  ...
  runNumbers.push_back(2083106);
  runNumbers.push_back(2083096);
  runNumbers.push_back(2083086);
  runNumbers.push_back(2083076);
  runNumbers.push_back(2083066);
  runNumbers.push_back(2083022);
  runNumbers.push_back(2083035);
  runNumbers.push_back(2083046);
  runNumbers.push_back(2083056);
  ...
  */
  ...
  //runsToPlotSchemeBModSpecialTrigAll, runsToPlotSchemeBMod, runsToPlotSchemeC, runsToPlotSchemeA
  ...
  if(listFile.is_open()){
    ...
    while (std::getline(listFile, fileLine)){
      ...
      resultsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/peakschi_raptorr_tpcdata_gain_" << fileLine << "_true_Am241.root.dat";
      paramsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/parameters_raptorr_tpcdata_gain_" << fileLine << "_true_Am241.root.dat"; 
      peaksSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/peaks_raptorr_tpcdata_gain_" << fileLine << "_true_Am241.root.dat"; 
   ...
   */
   ...
   //Scheme C
   /*         customVoltage.push_back(200);
   customVoltage.push_back(400);
   customVoltage.push_back(600);
   customVoltage.push_back(800);
   customVoltage.push_back(1000);
   customVoltage.push_back(1200);
   customVoltage.push_back(1400);
   customVoltage.push_back(1600);
   customVoltage.push_back(1800);
   */

   //Scheme B
   /*customVoltage.push_back(0);
   customVoltage.push_back(400);
   customVoltage.push_back(800);
   customVoltage.push_back(1200);
   customVoltage.push_back(1400);
   customVoltage.push_back(1600);
   customVoltage.push_back(1800);
   customVoltage.push_back(2000);
   customVoltage.push_back(2200);
   customVoltage.push_back(2400);
   customVoltage.push_back(2600);
   */
   ...
   */
   ...
   for(int iZack = 0; iZack < 5; iZack++){
     std::stringstream zackArray;
     std::stringstream voltageForName;
     voltageForName << customVoltage[iZack];
     zackArray << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/fitDataSchemeA_Anode3PeakmV" << voltageForName.str() << ".dat";
     std::ofstream zackFile;
     zackFile.open(zackArray.str().c_str());
     zackFile << Peaks2[iZack];
     zackFile << "\t";
     zackFile << scaledpeakErrors2[iZack];
     zackFile.close();
     std::cout << zackArray.str() <<  " created" << std::endl;
   }
   ...
   */
   ...
   //mg->Draw("A");
   peakGraph2.Draw("AP");
   //peakGraph2->GetXaxis()->SetTitle(xaxisname.str().c_str());
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData"+plottitle.str()+"_Anode3PeakmV_"+plottoplot+".pdf").c_str());
   }
   if(gain == true){ 
