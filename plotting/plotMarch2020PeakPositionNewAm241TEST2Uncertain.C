  ...
  */
   ...
   */
   ...
   for(int iZack = 0; iZack < 5; iZack++){
     ...
     zackFileName << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/fitDataUncertain" << SchemeName << "_" << GainString << voltageForName.str() << ".dat";
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Uncertain_"+SchemeName+"_Anode3PeakmV_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Gas Gain");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Uncertain_"+SchemeName+"_peakGain_"+"Custom"+".pdf").c_str());
   }
