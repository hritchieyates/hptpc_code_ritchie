...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = true){
   ...
   // listFilePrefix = "peakschi";
    //GasAgeing
    //SchemeA
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2081070-R2081084_true_Am241.rootAnode1.dat");
    ...
    //SchemeB
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2082009-R2082024_true_Am241.rootAnode1.dat");
    ...
    //SchemeC
    gasAgeingResultFile.push_back("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peakschi_raptorr_tpcdata_gain_R2083022-R2083032_true_Am241.rootAnode1.dat");
   ...
   //Fit Gas ageing plot and work out corrections from it
    ...
    c1->Print("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/AUTO_CORRECTED_UNCERTAIN_BKGR12_TEST_GASAGEING_Anode1.pdf");
  ...
  if(Scheme == "SchemeCMod5" || Scheme == "AllSchemesMod3"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
    //runNumbers.push_back(2083107); //bad?
    //runNumbers.push_back(2083097);//bad?  
    runNumbers.push_back(2083087);//bad?  
  ...
  if(Scheme == "SchemeBMod5" || Scheme == "AllSchemesMod3"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
    //    runNumbers.push_back(2084012); //bad?
    //runNumbers.push_back(2084002); //bad?
    //runNumbers.push_back(2083119);
    runNumbers.push_back(2082108); //bad?
    runNumbers.push_back(2082098);
    runNumbers.push_back(2082088);
    runNumbers.push_back(2082073);
    runNumbers.push_back(2082058);
    runNumbers.push_back(2082044);
    runNumbers.push_back(2082028);
  ...
  if(listFile.is_open()){
    ...
    while (std::getline(listFile, fileLine)){
      ...
      resultsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/" << listFilePrefix << "_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode1.dat";
      paramsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/parameters_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode1.dat"; 
      peaksSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peaks_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode1.dat"; 
      bkgrSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/bkgrparams_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode1.dat";
   ...
   */
   ...
   //Turn peaks into gain
    ...
    if(Scheme == "SchemeA"){
      ...
      peakGraph2Errors->SetMarkerColor(3);
      peakGraph2Errors->SetMarkerStyle(33);
      peakGraph2Errors->SetLineColor(3);
    ...
    if(Scheme == "SchemeCMod5"){
      ...
      xplot = a2a1Voltage;
      TGraphErrors* peakGraph2 = new TGraphErrors(7,&(xplot[0]),&(yplot[0]),0,&(yploterrors2[0]));
      ...
      peakGraph2->SetMarkerStyle(33);
      peakGraph2->SetLineStyle(2);
      peakGraph2->GetXaxis()->SetLimits(49,1925);
    }
    if(Scheme == "SchemeBMod5" || Scheme == "SchemeBModSpecialTrigAll"){
      xplot = a3a2Voltage;
      //xplot = schemeBCustomVoltage
      //TGraphErrors* peakGraph2 = new TGraphErrors(11,&(xplot[0]),&(Peaks2[0]),0,&(scaledpeakErrors2[0]));
      TGraphErrors* peakGraph2 = new TGraphErrors(8,&(xplot[0]),&(yplot[0]),0,&(yploterrors2[0]));
    ...
    */
    ...
    if(Scheme == "SchemeCMod5"){SchemeName = "SchemeC";}
    if(Scheme == "SchemeBModSpecialTrigAll" || Scheme == "SchemeBMod5"){SchemeName = "SchemeB";}
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/AUTO_CORRECTED_UNCERTAIN_BKGR12_TEST_"+SchemeName+"_Anode3"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Anode 1 Peak Position");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/AUTO_CORRECTED_UNCERTAIN_PEAKPOSITION_TEST_"+SchemeName+"_Anode1"+".pdf").c_str());
   }
