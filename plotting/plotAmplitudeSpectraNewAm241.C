...
void plotAmplitudeSpectraNewAm241(std::string inputFileName = "test.root",bool debug = true, bool cuts = true, int rebin = 25, double min = 0, double max = 450, std::string outFileExtension = ".png", bool changeRange = true){
  ...
  Double_t iBkgr11 = 4;
  Double_t iBkgr12 = 0.005;
  Double_t iPeak11 = 80;
  Double_t iPeak12 = 210;
  Double_t iPeak13 = 80;
  Double_t iPeak21 = 80;
  Double_t iPeak22 = 210;
  Double_t iPeak23 = 80;
  ...
  for(int i = 3; i <= 3; i++){
      ...
      fitFcn->SetParameters(bkgr01,bkgr02,80,210,80);
      ...
      //2nd Fit
      fitFcn9->SetParameters(bkgr11,bkgr12,peak11,peak12,peak13,80,210,80);
