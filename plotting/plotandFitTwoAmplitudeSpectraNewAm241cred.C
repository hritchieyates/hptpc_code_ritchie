...
void plotAmplitudeSpectraNewAm241(std::string inputFileName = "test.root", std::string secondInputFileName = "test2.root", bool debug = false, bool cuts = true, int rebin = 25, double min = 0, double max = 450, std::string outFileExtension = ".png", bool changeRange = true){
  ...
  for(int i = 3; i <= 3; i++){
      ...
      TH1D* HPeakMinusBaselineAnode3 = new TH1D("HPeakMinusBaselineAnode3","HPeakMinusBaselineAnode3",55,-10,1014);
      chargeGainAnalysisTreea->Draw(newhistotofit.str().c_str(), "", "goff");
      
      HPeakMinusBaselineAnode3->SetLineColor(2);
      //inputData->cd();
	...
	*/
      ...
      */
      ...
      TH1* HPeakMinusBaselineAnode3b = new TH1D("HPeakMinusBaselineAnode3b","HPeakMinusBaselineAnode3b",55,-10,1014);
      chargeGainAnalysisTreeb->Draw("AmplitudeAnode3 >> HPeakMinusBaselineAnode3b", "", "goff");

      HPeakMinusBaselineAnode3b->SetLineColor(4);
      //      secondInputData->cd();
      //      ampSpectraCanvas->cd();
      ...
      ampSpectraCanvas->Print((outDir+"/"+inputFileName+"_and_"+secondInputFileName+histotofit.str()+outFileExtension).c_str());
      ...
      Double_t compareChi = HPeakMinusBaselineAnode3->Chi2Test(HPeakMinusBaselineAnode3b);

      std::cout << "Good Fit = " << goodFit << std::endl;
      std::cout << "Bad Fit = " << badFit << std::endl;

      std::cout << "Chi2Test = " << compareChi << std::endl;
      /*
