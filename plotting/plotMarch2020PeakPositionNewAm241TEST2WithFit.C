...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
   ...
   */
   ...
   Double_t Interp_5day_A1 = peakGraph2->Eval(21.353, 0, "");
   Double_t Interp_5day_A2 = peakGraph2->Eval(21.513, 0, "");
   Double_t Interp_5day_A3 = peakGraph2->Eval(21.555, 0, "");
   Double_t Interp_5day_A4 = peakGraph2->Eval(21.631, 0, "");
   Double_t Interp_5day_A5 = peakGraph2->Eval(21.786, 0, "");

   std::cout << "Interp_5day_A1 = " << Interp_5day_A1 << std::endl;
   std::cout << "Interp_5day_A2 = " << Interp_5day_A2 << std::endl;
   std::cout << "Interp_5day_A3 = " << Interp_5day_A3 << std::endl;
   std::cout << "Interp_5day_A4 = " << Interp_5day_A4 << std::endl;
   std::cout << "Interp_5day_A5 = " << Interp_5day_A5 << std::endl;
