  ...
  */
   ...
   */
   ...
   std::vector<double> PeakCorrections;
     ...
     PeakCorrections.push_back(14.72);
     PeakCorrections.push_back(12.41);
     PeakCorrections.push_back(11.80);
     PeakCorrections.push_back(10.70);
     PeakCorrections.push_back(8.46);
   ...
   for(int chisub1 = 0; chisub1 < Chis4.size(); chisub1++){
    ...
    for(int errorsub2a = 0; errorsub2a < peakErrors2.size(); errorsub2a++){
	 ...
	 ageingUncertaintyVector.push_back(26);
       }
     }
   }
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/CORRECTEDUNCERTAINPEAKPOSITIONTEST_"+SchemeName+"_Anode2_"+".pdf").c_str());
   }
