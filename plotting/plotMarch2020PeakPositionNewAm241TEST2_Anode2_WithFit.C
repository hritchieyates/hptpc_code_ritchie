...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = true){
  ...
  std::string listFilePrefix;   
   ...
   //Include extra scheme called "AllSchemes" and "AllSchemesMod2
  ...
  */
  ...
  if(Scheme == "SchemeCMod4" || Scheme == "AllSchemesMod3"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
    runNumbers.push_back(2083107); //bad? thi sis treally really bad
    ...
    runDateTime.push_back(23.848);//bad? THIS Is really relaly bad  
  ...
  if(Scheme == "SchemeBMod4" || Scheme == "AllSchemesMod3"){
    listFileSuffix = "_true_Am241";
    listFilePrefix = "peakschi";
        runNumbers.push_back(2084012);
    runNumbers.push_back(2084002);
    runNumbers.push_back(2083119);
    runNumbers.push_back(2082108);
    ...
    runNumbers.push_back(2082012);
    runDateTime.push_back(23.018);
    runDateTime.push_back(23.965);
    runDateTime.push_back(23.914);
    runDateTime.push_back(22.894);
  ...
  if(listFile.is_open()){
    ...
    while (std::getline(listFile, fileLine)){
      ...
      resultsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/" << listFilePrefix << "_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode2.dat";
      paramsSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/parameters_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode2.dat"; 
      peaksSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/peaks_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode2.dat"; 
      bkgrSS << "/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/bkgFits/bkgrparams_raptorr_tpcdata_gain_" << fileLine << listFileSuffix << ".rootAnode2.dat";
   ...
   */
   ...
   Double_t Interp_1day_A1 = peakGraph2->Eval(21.353, 0, "");
   Double_t Interp_1day_A2 = peakGraph2->Eval(21.513, 0, "");
   Double_t Interp_1day_A3 = peakGraph2->Eval(21.555, 0, "");
   Double_t Interp_1day_A4 = peakGraph2->Eval(21.631, 0, "");
   Double_t Interp_1day_A5 = peakGraph2->Eval(21.786, 0, "");
   Double_t Interp_1day_B1 = peakGraph2->Eval(22.380, 0, "");
   ...
   std::cout << "Correction_to_A1 = " << Interp_1day_B1 - Interp_1day_A1 << std::endl;
   std::cout << "Correction_to_A2 = " << Interp_1day_B1 - Interp_1day_A2 << std::endl;
   std::cout << "Correction_to_A3 = " << Interp_1day_B1 - Interp_1day_A3 << std::endl;
   std::cout << "Correction_to_A4 = " << Interp_1day_B1 - Interp_1day_A4 << std::endl;
   std::cout << "Correction_to_A5 = " << Interp_1day_B1 - Interp_1day_A5 << std::endl;
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/PEAKPOSITIONTEST_"+SchemeName+"_Anode2_"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Anode 2 Peak Position");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/PEAKPOSITIONTEST_"+SchemeName+"_Anode2_"+".pdf").c_str());
   }
