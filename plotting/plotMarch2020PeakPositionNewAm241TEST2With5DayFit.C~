...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = false){
  ...
  */
   ...
   */
   ...
   //Turn peaks into gain
    ...
    if(Scheme == "GasAgeing"){
      ...
      xplot = runDateTime;
      TGraphErrors* peakGraph2 = new TGraphErrors(2,&(xplot[0]),&(yplot[0]),0,&(yploterrors[0]));
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Fitted_1Day_"+SchemeName+"_Anode3PeakmV_"+"Custom"+".pdf").c_str());
   }

   if(gain == true){ 
   peakGraph2->GetYaxis()->SetTitle("Gas Gain");
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/Fitted_1Day_"+SchemeName+"_peakGain_"+"Custom"+".pdf").c_str());
   }
