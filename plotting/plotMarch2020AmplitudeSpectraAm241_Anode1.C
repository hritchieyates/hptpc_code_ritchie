...
void plotAmplitudeSpectraNewAm241(std::string inputFileName = "test.root", bool debug = true, Double_t iBkgr11 = 4, Double_t iBkgr12 = 0.005, Double_t iPeak11 = 80, Double_t iPeak12 = 210, Double_t iPeak13 = 80, Double_t iPeak21 = 80, Double_t iPeak22 = 210, Double_t iPeak23 = 80, int noBins = 50, bool cuts = true, std::string outFileExtension = ".png"){
  ...
  //Define fits
  TF1 *fitFcn = new TF1("fitFcn",fitFunction,5, 30,5);
  fitFcn->SetParameters(4,-0.01,140,140,50);

  TF1 *Bkgr = new TF1("Bkgr",Background,5, 30,2);
  Bkgr->SetParameters(iBkgr11, iBkgr12);

  TF1 *fitFcn9 = new TF1("fitFcn9",fitFunction9,5,30,8);
  ...
  for(int i = 1; i <= 1; i++){
      ...
      plotTitle << "Waveform Amplitude Spectrum Anode 1" << i;
      ...
      TH1D* HPeakMinusBaselineAnode3 = new TH1D("HPeakMinusBaselineAnode3","HPeakMinusBaselineAnode3",noBins,-10,76);
	...
	if (chisqndfpeak4 >= chisqndfpeak3){
      ...
      */
      ...
      //Save Bkg Parameters                                                                
      std::string bkgrFileName = outDir+"/bkgrparams_"+inputFileName+histotofit.str()+".dat";
      ...
      //Save Fit Parameters
      std::string paramArray = outDir+"/parameters_"+inputFileName+histotofit.str()+".dat";
	...
	paramFile << pars8[i2];
      ...
      //Save Peaks + errors
      std::string peaksArray = outDir+"/peaks_"+inputFileName+histotofit.str()+".dat";
	...
	peaksFile << peaks[i3];
      ...
      std::string peakschiArray = outDir+"/peakschi_"+inputFileName+histotofit.str()+".dat";
	...
	peakschiFile << peakschi[i4];
      ...
      std::string peakschiArrayFirst = outDir+"/peakschifirst_"+inputFileName+histotofit.str()+".dat";
	...
	*/
      ...
      legPeakMinusBaseline->AddEntry(HPeakMinusBaselineAnode3, "anode 1");
