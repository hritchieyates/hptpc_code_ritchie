...
void LightVsCharge(TString Scheme = "A", TString ChargeType = "Entries"){
  ...
  fileToPlotPrefixStream << "Scheme" << Scheme << "_Clean_NoSparks_NoCuts";
  ...
  */
  ...
  if (Scheme == "A"){
    fin = "/home/zchenwis/s0/raptorr2/raptorr/src/dataproc/tpc/ccd/Sum_output_dir/sum_lightsumsquare_OUTPUT_SuperBias_SchemeA_box9x9_SBA1.root";}
  if (Scheme == "B"){
    fin = "/home/zchenwis/s0/raptorr2/raptorr/src/dataproc/tpc/ccd/Sum_output_dir/sum_lightsumsquare_OUTPUT_SuperBias_SchemeB_box9x9_SBB.root";
    listFileSuffix = "Mod";}
  if (Scheme == "C"){
    fin = "/home/zchenwis/s0/raptorr2/raptorr/src/dataproc/tpc/ccd/Sum_output_dir/sum_lightsumsquare_OUTPUT_SuperBias_SchemeC_box9x9_SBB.root";}
  ...
  if (Scheme == "A"){}//cout << "FATAL ERROR: No Data on Scheme A" << endl;}
	...
	entryVoltage_Vorder[i] = entryVoltage[i-3];
      }
    }
  }
  else if (Scheme == "C"){
...
th_to_" << listFileSuffix;
  ...
  if(ChargeType == "Entries"){
	...
	totalEntries = totalEntries + meanNoEntries;
	//	averageEntries = totalEntries / entryMeans.size();
	averageEntries = totalEntries / 25;
        std::cout << "total Eentries = " << totalEntries << "Average Entries = " << averageEntries << std::endl;
      }
  ...
  if (Scheme == "A"){
    if(ChargeType == "Entries"){
      plotGraph->SetTitle("Intergrated ADU vs Number of Entries:Scheme A");
      plotGraph->GetYaxis()->SetTitle("Number of Entries per Event");}
    else if(ChargeType == "PeakPosition"){
      plotGraph->SetTitle("Intergrated ADU vs Gas Gain:Scheme A");
