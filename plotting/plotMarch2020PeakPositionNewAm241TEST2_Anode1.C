...
void plotPeakPositionNewAm241(std::string Scheme= "noScheme", bool gain = true){
  ...
  */
   ...
   */
   ...
   //Turn peaks into gain
    ...
    if(Scheme == "SchemeBMod5" || Scheme == "SchemeBModSpecialTrigAll"){
      ...
      TGraphErrors* peakGraph2 = new TGraphErrors(8,&(xplot[0]),&(yplot[0]),0,&(yploterrors[0]));
   ...
   */
   ...
   c1->Print(("/scratch0/hrichie/hptpc_ritchie/HPTPC/data/fitData/PEAKPOSITIONTEST_"+SchemeName+"_Anode1_"+".pdf").c_str());
   }
